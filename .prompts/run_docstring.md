...
5. All parameters should be typed, have default values, and include an explanation or use case.
6. The exceptions section should include all possible exceptions that can be raised by the code.
7. Each docstring should include an example in the 'Examples' section, demonstrating both a typical use case and an edge case.
